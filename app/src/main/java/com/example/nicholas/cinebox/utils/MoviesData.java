...
public class MoviesData {
    ...
    /*Avengers*/
    public static final String AVENGER_TITLE = "Avengers";
    public static final String AVENGER_IMAGE = "https://upload.wikimedia.org/wikipedia/fi/thumb/f/f9/TheAvengers2012Poster.jpg/250px-TheAvengers2012Poster.jpg";
    public static final String AVENGER_DATE = "27 April, 2018";
    public static final String AVENGER_GENRE = "Action | Adventure | Fantasy";
    public static final String AVENGER_LANG = "English";
    public static final String AVENGER_PG = "PG-13";
    public static final String AVENGER_RATING = "8.7/10";
    public static final String AVENGER_DURATION = "2h 29min";
    public static final String AVENGER_DETAILS = "Iron Man, Thor, the Hulk and the rest of the Avengers unite to battle their most powerful enemy yet -- the evil Thanos. On a mission to collect all six Infinity Stones, Thanos plans to use the artifacts to inflict his twisted will on reality. The fate of the planet and existence itself has never been more uncertain as everything the Avengers have fought for has led up to this moment.";


    /*Jurassic World*/
    public static final String JURASSIC_TITLE = "Jurassic World: Fallen Kingdom";
    public static final String JURASSIC_IMAGE = "https://www.dvdsreleasedates.com/posters/800/J/Jurassic-World-Fallen-Kingdom-2018-movie-poster.jpg";
    public static final String JURASSIC_DATE = "27 April, 2018";
    public static final String JURASSIC_GENRE = "Action | Adventure | Sci-Fi";
    public static final String JURASSIC_LANG = "English";
    public static final String JURASSIC_PG = "PG-13";
    public static final String JURASSIC_RATING = "Rating: 6.6/10";
