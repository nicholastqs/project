...
public class SectionOneFragment extends Fragment {
    ...
    private void moviesData() {
        MoviesModel avengers = new MoviesModel(MoviesData.AVENGER_IMAGE, MoviesData.AVENGER_TITLE, MoviesData.AVENGER_GENRE, MoviesData.AVENGER_PG, MoviesData.AVENGER_DETAILS, MoviesData.AVENGER_DATE, MoviesData.AVENGER_DURATION);
        movies.add(avengers);
